...
export class Session extends EventEmitter implements SessionModel, ModelAdapterLike, ObjectWithType {
  ...
  protected _initInspector() {
    ...
    let debugParam = objects.parseBoolean(this.url.getParameter('debug') as string);
    let inspectorParam = objects.parseBoolean(this.url.getParameter('inspector') as string);
    ...
    this.inspector = scout.nvl(inspectorParam, debugParam, devMode);
  }
